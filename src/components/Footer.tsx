            ...
            <div className="space-y-3 text-xs text-slate-300 font-sans">
              ...
              <div className="flex gap-2 items-start">
                ...
                <div className="flex flex-col gap-1">
                  <a href="tel:+919725224433" className="text-slate-300 hover:text-white transition-colors">+91 97252 24433 (Primary)</a>
                  <a href="tel:+919558328627 " className="text-slate-300 hover:text-white transition-colors">+91 95583 28627 (Secondary)</a>
                </div>
              </div>
