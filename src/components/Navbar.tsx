...
export default function Navbar({ activeTab, setActiveTab }: NavbarProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-[#0a0a0a]/90 backdrop-blur-md border-b border-white/10">
          ...
          <div className="hidden md:flex items-center gap-6" id="nav-desktop-actions">
            <div className="flex flex-col items-end text-right">
              <a 
                ...
                className="text-[10px] uppercase tracking-[0.15em] font-bold text-white hover:text-brand-blue transition-colors"
              ...
              <a 
                ...
                className="text-[9px] uppercase tracking-[0.15em] font-medium text-white/40 hover:text-brand-blue transition-colors"
            ...
            <button
              ...
              className="px-6 py-3 border border-white/20 text-[10px] uppercase tracking-[0.3em] text-[#f2f2f2] hover:bg-white hover:text-black transition-colors cursor-pointer"
            >
            ...
            <div className="px-4 pt-2 pb-6 space-y-2">
              {navItems.map((item) => (
                <button
                  ...
                  className={`block w-full text-left px-4 py-3 rounded-xl font-sans text-xs uppercase tracking-[0.2em] transition-colors ${
                    activeTab === item.id
                      ? 'bg-white/5 text-white font-bold border-l-2 border-white'
              ...
              <div className="border-t border-white/10 pt-4 px-4 flex flex-col gap-3 font-sans">
                <div className="flex flex-col gap-2">
                  <a 
                    href="tel:+919558328627" 
                    className="flex items-center gap-3 text-xs uppercase tracking-[0.2em] text-white/60 hover:text-white"
                  >
                    <span className="text-[10px] text-brand-blue font-bold">Primary:</span>
                  ...
                  <a 
                    ...
                    className="flex items-center gap-3 text-xs uppercase tracking-[0.2em] text-white/60 hover:text-white"
                  >
                    <span className="text-[10px] text-[#e6994c] font-bold">Backup:</span>
                    <span>+91 97252 24433</span>
                  </a>
                </div>
                <button
                  onClick={() => handleNavClick('contact')}
                  className="w-full py-4 border border-white/20 text-[10px] uppercase tracking-[0.3em] text-[#f2f2f2] hover:bg-white hover:text-black transition-colors cursor-pointer"
                >
                  Build Custom Package
                </button>
              </div>
